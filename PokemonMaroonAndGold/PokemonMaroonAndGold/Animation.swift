...
class Animation: SKScene {
    ...
    func playVideo() {
        ...
        finishPlayingAnimationVideo(videoPlayer: player!)
    ...
    func finishPlayingAnimationVideo(videoPlayer: AVPlayer) {
...
//            videoPlayer.play()
            ...
            if let v = self.view {
                v.presentScene(self.controller.titleScreen, transition: transition)
            }
        }
    }
...
//            if let sampleName = childNode(withName: "video") as? SKVideoNode {
//                print("turn it off!")
//                sampleName.pause()
